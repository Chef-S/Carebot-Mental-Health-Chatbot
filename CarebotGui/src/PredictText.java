...
public class PredictText extends JFrame implements KeyListener
{
	...
	String chatBot[][] = {
			...
			{"Hello there! Care is 24/7 online for you","Hello dear!", "Hey It's Care, How can I help you?"},
			//question 1: 
			...
			//default
			{"Tell me more?", "do you wanna talk some more?","Would you like to tell me more about that?","How are you feeling now?" ,"How did it make you feel", "Let's talk about that"}
		...
		if(arg0.getKeyCode() == KeyEvent.VK_ENTER)
		{
			...
			*/
				...
				*/
				...
				//{
					if(similarInArray(quote,chatBot[j*2]))
					{
						...
						int r = (int) Math.floor(Math.random() * chatBot[(j*2) + 1].length);
						addText("\n--> Care:\t If you mean... - "+ chatBot[j*2][r] + "..then.." + chatBot[ (j*2) + 1 ][r] );
					}
					else
					{
						response = 0;
			...
			if( response==1 )
			{
				...
				addText("\n--> Care:\t " + chatBot[ chatBot.length-1 ][r] );
			}
		}
	}
